      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-lg-12 col-xl-11">
          <div
            ...
            style="border-radius: 25px; background-color: #5c86ac"
          >
              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <div class="text-center">
                    <router-link to="/signup"
                      >New User? Signup First</router-link
                    >
                  </div>
                </div>
                <div
                ...
                >
                  <img
                    ...
                    class="img-fluid"
                    style="width: 1200px; height: 350px; border-radius: 25px"
                    alt="Sample image"
                    draggable="false"
                  />
                </div>
  ...
  methods: {
    ...
    login() {
      ...
      if (this.email == "" || this.password == "") {
        ...
        const url = "http://localhost:3300/trial/user/login";
        // console.log(data);
        axios
          .post(url, data)
          .then((response) => {
            ...
            if (response.status == 200) {
              ...
              setToken(JSON.stringify(response.data), "users");
              this.$router.push("/");
